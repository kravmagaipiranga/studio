...
export function PrivateClassForm({ privateClass, allStudents }: PrivateClassFormProps) {
  ...
  }, [isEditing, privateClass, allStudents])
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const privateClassId = isEditing ? privateClass.id : doc(collection(firestore, "privateClasses")).id;
