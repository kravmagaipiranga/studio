...
export function SeminarForm({ seminar, allStudents }: SeminarFormProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const studentAge = differenceInYears(new Date(), new Date(selectedStudent.dob));
