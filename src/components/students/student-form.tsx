...
export function StudentForm({ student, onFormSubmit }: StudentFormProps) {
  ...
  return (
    <Card className="w-full">
        <CardHeader>
            <CardTitle>{isEditing ? "Editar Aluno" : "Adicionar Novo Aluno"}</CardTitle>
            <CardDescription>
                {isEditing ? "Altere as informações abaixo para atualizar o cadastro." : "Preencha os dados para adicionar um novo aluno."}
            </CardDescription>
        </CardHeader>
        <CardContent>
            <Form {...form}>
